...
export default async function (
  ...
  { camera, torch }: { camera: string; torch: string }
) {
  ...
  //   // @ts-ignore
  // } else if (videoEl.value.mozSrcObject !== undefined) {
  //   // @ts-ignore
  //   videoEl.value.mozSrcObject = stream
  // } else if (window.URL.createObjectURL) {
  //   // @ts-ignore
  //   videoEl.value.src = window.URL.createObjectURL(stream)
  // } else if (window.webkitURL) {
  //   // @ts-ignore
  //   videoEl.value.src = window.webkitURL.createObjectURL(stream)
  // } else {
  //   videoEl.value.src = stream.id
  // }

  await eventOn(videoEl.value, 'loadeddata')
  ...
  return new Camera(videoEl.value, stream)
}
