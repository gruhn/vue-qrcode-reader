module.exports = (function(e) {
    ...
    e.exports = {
      ...
      detectBrowser: function(e) {
        var t = e && e.navigator,
          r = {};
        if (
          ((r.browser = null), (r.version = null), void 0 === e || !e.navigator)
        )
  ...
  function(e, t) {
    e.exports = function(e, t, r, o) {
      ...
      if (
        (t && ((c.render = t.render), (c.staticRenderFns = t.staticRenderFns)),
        r && (c._scopeId = r),
        o)
      ) {
  ...
  function(e, t, r) {
    e.exports = { default: r(66), __esModule: !0 };
  },
  function(e, t) {},
  function(e, t, r) {
    "use strict";
    ...
    e.exports = function(e, t, r, m, v, h, k) {
      ...
      if (
        (E &&
          ...
          g.next &&
          (d(g, P, !0), o || "function" == typeof g[l] || i(g, l, p)),
        w &&
          T &&
          "values" !== T.name &&
          ((b = !0),
  ...
  function(e, t, r) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.install = o);
    var n = r(63),
      a = r.n(n);
  ...
  function(e, t, r) {
    r(64);
    var o = r(38)(r(65), r(139), "data-v-1f90552a", null);
    e.exports = o.exports;
  },
  function(e, t) {},
  function(e, t, r) {
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if ((e.beforeResetCamera(), void 0 !== e.constraints)) {
                          t.next = 5;
                          break;
                        }
  ...
  function(e, t, r) {
    r(40), r(41), r(49), r(76), r(88), r(89), (e.exports = r(1).Promise);
  },
  function(e, t, r) {
    var o = r(23),
      n = r(24);
      ...
      t = (e.exports = function(e, t, r, l, f) {
        ...
        if (a(k)) {
          for (p = c(e.length); p > y; y++)
            if ((h = t ? C(i((m = e[y]))[0], m[1]) : C(e[y])) === d || h === u)
              return h;
        } else
  ...
  function(e, t, r) {
    ...
    if (((o.regeneratorRuntime = void 0), (e.exports = r(91)), n))
  ...
  function(e, t) {
    !(function(t) {
      ...
      function u(e, t) {
        ...
        if ("throw" === n.type)
          return (t.method = "throw"), (t.arg = n.arg), (t.delegate = null), E;
        var a = n.arg;
        return a
          ? a.done
      ...
      var L = (i.prototype = n.prototype = Object.create(_));
      (a.prototype = L.constructor = i),
        (i.constructor = a),
        (i[P] = a.displayName = "GeneratorFunction"),
        ...
        (b.mark = function(e) {
          return (
            Object.setPrototypeOf
              ...
              : ((e.__proto__ = i), P in e || (e[P] = "GeneratorFunction")),
  ...
  function(e, t, r) {
    e.exports = { default: r(97), __esModule: !0 };
  },
  function(e, t, r) {
    r(98);
    var o = r(1).Object;
      ...
      switch (s.browser) {
        case "chrome":
          if (!d || !d.shimPeerConnection || !a.shimChrome)
            return c("Chrome shim is not included in this adapter release."), m;
        ...
        case "safari":
          if (!f || !a.shimSafari)
            return c("Safari shim is not included in this adapter release."), m;
      ...
      Object.defineProperty(p.prototype, "localDescription", {
        ...
        (p.prototype.setRemoteDescription = function(o) {
          ...
          if (
            ...
            return Promise.reject(
              d(
                "InvalidStateError",
                "Can not set remote " + o.type + " in state " + n.signalingState
              )
            );
          var a = {};
            ...
            m.forEach(function(c, d) {
              ...
              if (
                ...
                if ("answer" === o.type && !C) {
                  ...
                  var A = i(w.localCapabilities, w.remoteCapabilities),
                  ...
                  !F &&
                    ...
                    !x || ("sendrecv" !== g && "sendonly" !== g)
                      ...
                      : ((M = x.track),
                        B
                          ? (a[B.stream] || (a[B.stream] = new e.MediaStream()),
                            r(M, a[B.stream]),
                ...
                (w = n.transceivers[d] || n._createTransceiver(m)),
                  (w.mid = P),
                  w.iceGatherer || (w.iceGatherer = n._createIceGatherer(d, k)),
                  N.length &&
        ...
        (p.prototype.createOffer = function() {
          ...
          r.transceivers.forEach(function(o, n) {
            ...
            var d = o.sendEncodingParameters || [{ ssrc: 1001 * (2 * n + 1) }];
            a &&
              t >= 15019 &&
              "video" === i &&
              !d[0].rtx &&
            ...
            r.transceivers.forEach(function(e, t) {
              (c += n(e, e.localCapabilities, "offer", e.stream, r._dtlsRole)),
                (c += "a=rtcp-rsize\r\n"),
                !e.iceGatherer ||
          ...
          return e && void 0 === e.sdpMLineIndex && !e.sdpMid
            ...
            : new Promise(function(o, n) {
                ...
                if (e && "" !== e.candidate) {
                  ...
                  if (!c)
                    return n(d("OperationError", "Can not add ICE candidate"));
                  ...
                  0 === f.indexOf("a=") && (f = f.substr(2)),
                    ...
                    (r._remoteDescription.sdp =
                      u.getDescription(r._remoteDescription.sdp) + t.join(""));
        ...
        e.RTCPeerConnection.prototype.createOffer = function(e) {
          ...
          if (e) {
            ...
            !1 === e.offerToReceiveAudio && o
              ...
              : !0 !== e.offerToReceiveAudio || o || r.addTransceiver("audio"),
            ...
            !1 === e.offerToReceiveVideo && n
              ...
              : !0 !== e.offerToReceiveVideo || n || r.addTransceiver("video");
          }
  ...
  function(e, t, r) {
    e.exports = { default: r(111), __esModule: !0 };
  },
  function(e, t, r) {
    r(112), (e.exports = r(1).Object.getPrototypeOf);
  },
  function(e, t, r) {
    var o = r(32),
      n = r(48);
    r(113)("getPrototypeOf", function() {
      return function(e) {
        return n(o(e));
      };
    });
  ...
  function(e, t, r) {
    r(119), r(40), r(124), r(125), (e.exports = r(1).Symbol);
  },
  function(e, t, r) {
    "use strict";
    var o = r(0),
    ...
    X ||
      ...
      (r(37).f = Y),
      (x.f = te),
      a && !r(12) && c(z, "propertyIsEnumerable", Y, !0),
      (m.f = function(e) {
        return W(p(e));
      })),
    ...
    for (
      ...
      p(re[oe++]);
    for (var ne = E(p.store), ae = 0; ne.length > ae; ) v(ne[ae++]);
    i(i.S + i.F * !X, "Symbol", {
      for: function(e) {
  ...
  function(e, t, r) {
    e.exports = { default: r(128), __esModule: !0 };
  },
  function(e, t, r) {
    r(129), (e.exports = r(1).Object.setPrototypeOf);
  },
  function(e, t, r) {
    var o = r(3);
    o(o.S, "Object", { setPrototypeOf: r(130).set });
  },
  function(e, t, r) {
    var o = r(7),
      n = r(4),
  ...
  function(e, t, r) {
    var o = r(38)(r(136), null, null, null);
    e.exports = o.exports;
  },
  function(e, t, r) {
    "use strict";
